...
for i in range(1, 9):
    ...
    if n > 0:
        ...
        with torch.no_grad():
            z_class = encoder(xclass_t).cpu().numpy()
        
        xsamp, ysamp = G_SM(z_class, yclass, n, i)
        ...
        print(f"Decoded images: {ximn.shape}")
...
with open(os.path.join(out_lab_dir, 'train.json'), 'w') as f:
    json.dump(data, f, indent=2, cls=NumpyEncoder)
print(f"Saved augmented annotations to {out_lab_dir}/train.json")
